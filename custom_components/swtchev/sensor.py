...
async def async_setup_entry(
    ...
    async_add_entities([SwtchSensorEntity(coordinator, description) for description in SENSORS])
...
class SwtchSensorEntity(SwtchCoordinatorEntity, SensorEntity):
    ...
    def native_value(self):
        ...
        if desc.value_type == "power":
            ...
            voltage = nested_get(data, ("data", "csInfo", "evses", 0, "connectors", 0, "voltage"), 0)
            try:
